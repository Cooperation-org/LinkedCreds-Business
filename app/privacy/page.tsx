    ...
    <main className='privacy-policy-container'>
      <div className='privacy-policy-box'>
        <header className='privacy-policy-header'>
          <a
            href='/'
            aria-label='LinkedCreds - Business Home'
            className='privacy-policy-link'
          >
            <Logo />
            <span className='privacy-policy-logo-text'>LinkedCreds - Business</span>
          </a>
        </header>
        ...
        <section className='privacy-policy-paper'>
          ...
          <p className='privacy-policy-paragraph'>
            LinkedCreds - Business is an open-source web application developed by the{' '}
            <a
